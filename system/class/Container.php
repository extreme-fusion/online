...
class Container extends ServiceContainerBuilder
{
	...
	{
		return new Modules($this->getService('Pdo'), $this->getService('Sett'), $this->getService('User'), $this->getService('Tag'), $this->getService('Locales'), $this->getService('System'), $this->getService('Request'));
	}
