...
return array(
	...
	//E-mail messages
	'Asked to change your password on website: :sitename avaible at address: <a href=":addressite">:addressite</a>.:eol If you did not use password recovery option, please ignore this message.:eol To generate new password, please go to the following website address: :eol <a href=":addrgen">:addrgen</a>' => 'Poproszono o zmianę hasła w serwisie: :sitename dostępnym pod adresem: <a href=":addressite">:addressite</a>.:eol Jeżeli nie korzystałeś/aś z procedury odzyskiwania dostępu do konta, prosimy o zignorowanie tej wiadomości.:eol W celu wygenerowania nowego hasła, proszę przejść pod nastepujący adres: :eol <a href=":addrgen">:addrgen</a>',
	'New Password » :sitename' => 'Nowe hasło » :sitename',
	'Your new password: :pass. Thank you for using password recovery system' => 'Twoje nowe hasło: :pass. Dziękujemy za skorzystanie z systemu odzyskiwania konta',
